	...
	'tx_kist_values_color_scheme' => [
		...
		'config' => [
			...
			'items' => [
				...
				['LLL:EXT:ps14_kist_values/Resources/Private/Language/locallang_tca.xlf:elements.color-scheme.white-primary', 'white-primary'],
				['LLL:EXT:ps14_kist_values/Resources/Private/Language/locallang_tca.xlf:elements.color-scheme.white-secondary', 'white-secondary'],
				['LLL:EXT:ps14_kist_values/Resources/Private/Language/locallang_tca.xlf:elements.color-scheme.primary-default', 'primary-default'],
				['LLL:EXT:ps14_kist_values/Resources/Private/Language/locallang_tca.xlf:elements.color-scheme.primary-light', 'primary-light'],
				['LLL:EXT:ps14_kist_values/Resources/Private/Language/locallang_tca.xlf:elements.color-scheme.secondary-default', 'secondary-default'],
				['LLL:EXT:ps14_kist_values/Resources/Private/Language/locallang_tca.xlf:elements.color-scheme.secondary-light', 'secondary-light'],
				['LLL:EXT:ps14_kist_values/Resources/Private/Language/locallang_tca.xlf:elements.color-scheme.grey-default', 'grey-default'],
			],
		],
	],
]);